...
<head>
    ...
    <title>PC Information Addition</title>
...
<body>
    ...
    <%
        ArrayList<String> usernames = pc.getListOfUsernames();
    %>

        <form action="add_pc_processing.jsp" method="post">
            <h1>Add PC Information</h1>

            <label for="username">Latest Username:</label>
        <select name="username"  id="username">
            <%
                for (String username : pc.latestUsernameList) {
            %>
        ...
        <input type="text" id="pc_type" name="pc_type" required>
